...
class Data_Dumper:
    ...
    def add_item_type(self,  Item_type):
        ...
        if db_Item:
            ...
            cur.execute('INSERT INTO bis."ItemType" ( "ItemTyp_ID","ItemTyp_Company_ID","ItemTyp_Client_ID","ItemTyp_Descr") VALUES ( %s,%s,%s,%s) ON CONFLICT DO NOTHING',
                        (Item_type, self.Company_ID, self.Company_Client_ID, Item_type))
            conn.commit()
    ...
    def add_manufacturer(self,  Manufacturer, Item_type):
        ...
        if db_Item:
            ...
            cur.execute('INSERT INTO bis."Manufacturer" ( "Mfr_ID","Mfr_Name","Mfr_Company_ID","Mfr_Client_ID","Mfr_ItemTyp_Key") VALUES ( %s,%s,%s,%s,%s) ON CONFLICT DO NOTHING',
                        (Manufacturer, Manufacturer, self.Company_ID, self.Company_Client_ID, Mfr_ItemTyp_Key))
            conn.commit()
            print("Data added Successfully")
        ...
        while uom:
            for Uom in uom:
                ...
                if db_Item:
                    ...
                    cur.execute('INSERT INTO bis."UOMType" ( "UOMTyp_ID","UOMTyp_Descr","UOMTyp_Company_ID","UOMTyp_Client_ID" ) VALUES ( %s,%s,%s,%s) ON CONFLICT DO NOTHING',
                                (Uom, Uom, self.Company_ID, self.Company_Client_ID))
                    conn.commit()
                    print("Data added Successfully")
                uom.remove(Uom)
        ...
        while uom:
            for Uom in uom:
                ...
                if db_Item:
                    ...
                    cur.execute('INSERT INTO bis."ItemUOM" ( "ItemUOM_ID","ItemUOM_Descr","ItemUOM_Company_ID","ItemUOM_Client_ID","ItemUOM_UOMTyp_Key","ItemUOM_ItemTyp_Key") VALUES ( %s,%s,%s,%s,%s,%s) ON CONFLICT DO NOTHING',
                                (Uom, Uom, self.Company_ID, self.Company_Client_ID, ItemUOM_UOMTyp_Key, ItemUOM_ItemTyp_Key))
                    conn.commit()
                    print("Data added Successfully")
                uom.remove(Uom)
        ...
        while uom:
            for Uom in uom:
                ...
                if db_Item:
                    ...
                    cur.execute('INSERT INTO bis."ItemSubType" ( "ItemSubTyp_ID","ItemSubTyp_Descr","ItemSubTyp_Company_ID","ItemSubTyp_Client_ID","ItemSubTyp_Uom_Keys","ItemSubTyp_ItemTyp_Key","ItemSubTyp_Gst") VALUES (  %s,%s,%s,%s,%s,%s,%s) ON CONFLICT DO NOTHING',
                                (Item_sub_type, Item_sub_type, self.Company_ID, self.Company_Client_ID, ItemUOM_UOMTyp_Key, ItemSubTyp_ItemTyp_Key, self.Gst))
                    conn.commit()
                    print("Data added Successfully")
                uom.remove(Uom)
        ...
        while uom:
            for Uom in uom:
                ...
                if db_Item:
                    ...
                    cur.execute('INSERT INTO bis."Item" ( "Item_ID","Item_Descr","Item_StockType","Item_ItemTyp_Key","Item_ItemUOM_Key","Item_Mfr_Key","Item_Company_ID","Item_Client_ID","Item_SubType_Key","Item_ItemUOMs","Item_Gst") VALUES ( %s, %s, %s, %s, %s,%s, %s, %s,%s,%s,%s) ON CONFLICT DO NOTHING',
                                (Item_name, Item_name, Item_StockType,  ItemTyp_key,  ItemUOM_UOM_Key, Item_Manufacturer_key, self.Company_ID, self.Company_Client_ID, ItemSubTyp_Key, ItemUOM_UOMTyp_Key, self.Gst))
                    conn.commit()
                    print("Data added Successfully")
                uom.remove(Uom)
        ...
        while values:
            for i in values:
                ...
                if pd.isnull(ItemSpec_ID):
                    ...
                    cur.execute('INSERT INTO bis."ItemSpecification" ( "ItemSpec_ID","ItemSpec_Name","ItemSpec_Value","ItemSpec_Client_ID","ItemSpec_Company_ID","ItemSpec_Item_key") VALUES (  %s, %s, %s, %s, %s, %s) ON CONFLICT DO NOTHING',
                                (ItemSpec_ID, Spec_name, Spec_value,  self.Company_Client_ID, self.Company_ID, Item_Key))
                    conn.commit()
                    print("Data added Successfully")
